...
CopyBox Lite 的诞生初衷是为了在各种工作场景中（如处理邮件客服、高频使用 AI 提示词、快捷调用 API 参数等），提供一个最轻量、最快捷的文本片段管理和粘贴工具。

本项目完全免费开源，不含任何广告和多余权限，所有数据完全保存在您的电脑本地。如果你喜欢这个插件，欢迎给个 Star ⭐！
